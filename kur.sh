...
if grep -qs "Ubuntu 16.04" "/etc/os-release"; then
	...
	echo "Go to https://raw.githubusercontent.com/kafkasdogukan/openvpn-multi-kurulumu/main/kur.sh for FAQ"
	exit
fi
...
if [[ -e /etc/openvpn/server/server.conf ]]; then
	...
	echo "Go to https://raw.githubusercontent.com/kafkasdogukan/openvpn-multi-kurulumu/main/kur.sh"
	echo
...
NLDiPnjyVw5l//////////+t+FRYortKmq/cViAnPTzx2LnFg84tNpWp4TZBFGQz
+8yTnc4kmz75fS/jY2MMddj2gbICrsRhetPfHtXV/WVhJDP1H18GbtCFY2VVPe0a
87VXE15/NLDiPnjyVw5llG1mMJ4LN+/och3xWKE2rec1MKzKT0g6eXq8CrGCsyT7
